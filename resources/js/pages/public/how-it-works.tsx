    ...
    const renderStep = (step: any, index: number, isLast: boolean) => {
        ...
        return (
            <div key={index} className="relative">
                <div className="bg-white p-6 rounded-xl shadow-md border-2 border-gray-200 hover:border-primary/30 transition-all text-center">
                ...
                <div className="relative z-10 container mx-auto px-4 max-w-7xl">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                            How <span className="text-primary">eDalaw</span> Works
                        </h1>
