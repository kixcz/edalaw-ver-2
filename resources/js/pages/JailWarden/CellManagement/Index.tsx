    ...
    return (
        <AppLayout>
                ...
                <div className="bg-card border-b border-border px-6 py-5 sticky top-0 z-30 shadow-sm">
                    <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div><h1 className="text-lg font-bold text-foreground leading-none">Cell Management</h1><p className="text-xs text-muted-foreground mt-0.5">Manage cells across all dormitories</p></div>
                        </div>
                ...
                <div className="max-w-screen-2xl mx-auto px-6 py-6 space-y-6">
                    ...
                    <Tabs defaultValue="records" className="space-y-4">
                        <TabsList className="bg-card border border-border p-1 rounded-xl shadow-sm h-auto gap-1">
                            <TabsTrigger value="records" className="data-[state=active]:text-primary rounded-lg px-4 py-2 text-sm font-medium text-muted-foreground gap-2 transition-all"><List className="w-4 h-4" />Cells</TabsTrigger>
                        ...
                        <TabsContent value="analytics">
                            <div className="grid gap-4 md:grid-cols-2">
                                <Card className="border-0 shadow-sm">
                                    <div className="px-6 pt-5 pb-2 border-b border-border"><h4 className="font-semibold text-foreground text-sm">Cells by Status</h4><p className="text-xs text-muted-foreground mt-0.5">Active vs Inactive distribution</p></div>
            ...
            <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
                <DialogContent className="sm:max-w-lg"><DialogHeader><DialogTitle>Edit Cell</DialogTitle><DialogDescription>Update cell information.</DialogDescription></DialogHeader>
