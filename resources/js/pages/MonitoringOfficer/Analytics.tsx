...
const getBreadcrumbs = (): BreadcrumbItem[] => {
    ...
    const isDashboard = path === '/dashboard/monitoring-officer' || path === '/dashboard';
    return [
...
export default function Analytics({
    ...
    const filterUrl = typeof window !== 'undefined' && window.location.pathname === '/dashboard/monitoring-officer'
        ? '/dashboard/monitoring-officer'
        : '/monitoring-officer/analytics';
    ...
    const exportCsv = () => {
        ...
        window.location.href = `/monitoring-officer/analytics/export/csv?${params.toString()}`;
    };
                ...
                <div className="grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Sessions being recorded</p>
                        </CardContent>
                    </Card>
                </div>
