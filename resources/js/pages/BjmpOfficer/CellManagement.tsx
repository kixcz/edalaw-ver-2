                            ...
                            <Card className="border-0 shadow-sm">
                                ...
                                <div className="overflow-x-auto">
                                    <Table>
                                        ...
                                        <TableBody>
                                            {cells.data.map((c) => (
                                                <TableRow key={c.id} className="hover:bg-muted transition-colors group">
                                                    <TableCell className="pl-6"><span className="font-semibold text-foreground text-sm">{c.cell_number}</span></TableCell>
                                                    <TableCell className="text-right text-sm font-medium text-foreground/80">{c.capacity}</TableCell>
                ...
                <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                    <DialogContent className="sm:max-w-lg">
                        <DialogHeader>
                            ...
                            <DialogDescription>Add a new cell to a dormitory. Fill in the required fields below.</DialogDescription>
                        </DialogHeader>
                        <form onSubmit={(e) => { e.preventDefault(); createForm.post('/bjmp-officer/cells', { onSuccess: () => setIsCreateOpen(false) }); }}>
                            <div className="space-y-4 py-4">
                                <div className="space-y-2"><Label>Dormitory</Label>
            ...
            {isEditOpen && selected && (
                <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                    <DialogContent className="sm:max-w-lg">
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); editForm.put(`/bjmp-officer/cells/${selected.id}`, { onSuccess: () => setIsEditOpen(false) }); }}>
                            <div className="space-y-4 py-4">
                                <div className="space-y-2"><Label>Dormitory</Label>
                ...
                <Dialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
                    <DialogContent className="sm:max-w-lg">
                        <DialogHeader>
                            ...
                            <DialogDescription>This action cannot be undone. The cell will be permanently removed.</DialogDescription>
                        </DialogHeader>
