            ...
            {isCreateOpen && (
                <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                    <DialogContent className="sm:max-w-md">
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); createForm.post('/jail-officer/cells-hierarchical', { onSuccess: () => setIsCreateOpen(false) }); }} className="space-y-4">
            ...
            {isEditOpen && selected && (
                <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                    <DialogContent className="sm:max-w-md">
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); editForm.put(`/jail-officer/cells-hierarchical/${selected.id}`, { onSuccess: () => setIsEditOpen(false) }); }} className="space-y-4">
