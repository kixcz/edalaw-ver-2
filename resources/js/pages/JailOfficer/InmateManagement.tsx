            ...
            {isCreateOpen && (
                <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                    <DialogContent className="sm:max-w-md">
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); createForm.post('/jail-officer/inmates-hierarchical', { onSuccess: () => setIsCreateOpen(false) }); }} className="space-y-4">
            ...
            {isEditOpen && selected && (
                <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                    <DialogContent className="sm:max-w-md">
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); editForm.put(`/jail-officer/inmates-hierarchical/${selected.id}`, { onSuccess: () => setIsEditOpen(false) }); }} className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
            ...
            {isTransferOpen && selected && (
                <Dialog open={isTransferOpen} onOpenChange={setIsTransferOpen}>
                    <DialogContent className="sm:max-w-md">
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); transferForm.post(`/jail-officer/inmates-hierarchical/${selected.id}/transfer`, { onSuccess: () => setIsTransferOpen(false) }); }} className="space-y-4">
